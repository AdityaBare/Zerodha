...
function Footer() {
    ...
    return ( 
       <footer>
       <div className="container footer p-5 border-top">
        <div className="row m-4 ">
          <div className="col">
            ...
            <div>
              <a href=""><i class="fa-solid fa-x a"></i></a>
              <a href=""><i class="fa-brands fa-square-facebook a"></i></a>
              <a href=""><i class="fa-brands fa-instagram a"></i></a>
              <a href=""><i class="fa-brands fa-linkedin a"></i></a>
            </div>
            <hr />
            <div>
              <a href=""> 
                <i class="fa-brands fa-square-whatsapp a"></i>
              </a>
              <a href="">
                <i class="fa-brands fa-youtube a"></i>
              </a>
              <a href="">
                <i class="fa-brands fa-telegram a"></i>
              </a>
            </div>
       ...
       <div className='mt-5 p-2 text-muted  text-small '>
